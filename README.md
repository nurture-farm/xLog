...
```groovy
add 
        maven { url "http://mvn.neebal.com/content/repositories/releases/" }
to allprojects in build.gradle	of project
then add
    compile 'com.neebal.libraries:xLog:1.4.2'
in build.gradle of application
```
...
](http://developer.android.com/reference/anPrinterdroid/app/Application.html#onCreate()).
